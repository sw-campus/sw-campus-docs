...
| **1-2** | 🔄 계정 전환  | test_user_1@test.com 준비된 계정으로 로그인                 | 시연용 계정 전환   |
| **1-3** | 🏠 메인       | 배너, 추천 강의, 최신 강의 섹션 확인                       | 메인 UI 애니메이션 |
| **1-4** | 🔍 검색       | 카테고리 선택 → 키워드 검색 → 결과 확인                    | 필터/검색 기능     |
| **1-5** | 📄 강의 상세  | 강의 정보 스크롤 → **AI 리뷰 요약** 보여주기               | **AI 리뷰 요약**   |
| **1-6** | 🛒 장바구니   | 강의 여러 개 담기 → **AI 비교 분석** 버튼 클릭             | **AI 강의 비교**   |
| **1-7** | 📝 리뷰 작성  | **수료증 이미지 업로드** → OCR 스캔 애니메이션 → 리뷰 등록 | **OCR 인증**       |
| **1-8** | 👤 마이페이지 | 내 정보, 설문, 작성 리뷰 목록 확인                         | 개인화 기능        |
...
|  순서   | 화면          | 행동                                                   | 핵심 포인트    |
| :-----: | :------------ | :----------------------------------------------------- | :------------- |
| **2-1** | 🔐 로그인     | test_org_1@test.com 승인된 기관 계정으로 로그인          | 기관 로그인    |
| **2-2** | 🏢 마이페이지 | 기관 정보 관리 화면 확인                               | 기관 전용 UI   |
| **2-3** | ➕ 강의 등록  | **새 강의 등록** - 제목, 설명, 커리큘럼, 이미지 업로드 | 강의 등록 기능 |
| **2-4** | ✏️ 강의 수정  | 등록된 강의 선택 → 정보 **수정** 후 저장               | 강의 수정 기능 |
| **2-5** | 📊 강의 관리  | 등록된 강의 목록, 승인 상태 확인                       | 기관 대시보드  |
| **2-6** | 💬 리뷰 관리  | 해당 기관 강의들의 리뷰 목록 확인                      | 피드백 관리    |
